...
The dataset used for this project contains real-world data science job information from 2023. The dataset is available via my Excel project, which provides a foundation for analyzing data using Excel. 
...
- ⚖️ Analyst and scientist roles offer similar pay to engineering roles but require fewer skills, suggesting an easier path to equal compensation.
